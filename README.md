...
>
> **v3.3.1** — 16,735 条纯正科研俄语模板，语义理解 + 三层回退检索 | 16,735 templates, semantic retrieval + 3-layer fallback | 16 735 шаблонов, семантический поиск
...
New (v3.3.1): "Целью работы является..." → understand intent "формулировка цели" → INTRO
```
