...
写作结果部分：数值汇报、性能提升、分布分析、案例分析、对比表格。

## 分类

### RESULT
- numeric_reporting / improvement_reporting
- distribution_reporting / case_studies
- failure_cases / comparison_table
...
• improvement_reporting 不要只报最好结果
• failure_cases 同样重要，不要隐瞒
• comparison_table 要有公平的比较条件
