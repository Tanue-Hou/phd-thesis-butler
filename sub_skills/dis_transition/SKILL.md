...
description: "TRANSITION 句式模板与用法"
version: "2.1"
model: xiaomi mimo v2.5
---

# DIS TRANSITION — 过渡承接句式库

## 用途

写作过渡与承接：章节开头引入、结尾过渡、段间连接、下文预告。

## 分类

### TRANSITION
- section_openers / section_closers
- paragraph_linkers / signposting
...
• paragraph_linkers 不要过度使用套路化词汇
• signposting 要自然融入正文，不要生硬
• section_closers 要承上启下
