...
讨论句式模板，用于博士论文Обсуждение章节的写作辅助。

## Category

**DISCUSSION** — 讨论

Relevant subtypes: интерпретация, объяснение, ограничения, сравнение

## Retrieval files (in priority order)

1. `assets/discipline/технические_науки.jsonl` — discipline-specific templates (default)
2. `assets/cluster/TECH_LIFE/quality/QUALITY2_DISCUSSION.jsonl` — cluster-level quality templates
3. `assets/global/quality/QUALITY2_DISCUSSION.jsonl` — cross-cluster templates
